    ...
    <el-card class="box-card">
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    ...
                    <el-button type="danger"  @click="onClickForDeleteRole(scope.row._id)" plain size="mini" icon="el-icon-delete" circle ></el-button>
                    <!-- :disabled="!$store.state.authList.includes('删除角色')" -->
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog title="添加角色" :visible.sync="dialogFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="onClickForAddRole" >确 定</el-button>
                <!-- :disabled="!this.$store.state.authList.includes('添加角色')" -->
            </div>
        </el-dialog>
