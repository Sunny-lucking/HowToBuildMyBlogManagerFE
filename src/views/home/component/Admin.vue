    ...
    <el-card class="box-card">
        ...
        <el-row>
            <el-col>
                ...
                <el-button type="success" style="margin-left: 20px" @click="dialogFormVisible =true">添加管理员</el-button>
            </el-col>
        </el-row>
        <!--表格-->
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    ...
                    <!-- :disabled="!$store.state.authList.includes('删除管理员')" -->
                </template>
            </el-table-column>
        </el-table>
        <!--分页-->
        ...
        <el-dialog title="分配角色" :visible.sync="roleFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="onClickForSetRole" :disabled="!this.$store.state.authList.includes('分配角色')">确 定</el-button>
                <!-- :disabled="!this.$store.state.authList.includes('分配角色')" -->
            </div>
        </el-dialog>
    </el-card>
</template>
