            ...
            <el-tabs tab-position="left"   v-model="activeIndex">
                ...
                <el-tab-pane label="标签" name="3">
                    <el-form-item label="标签">
                        <el-input v-model="form.tag" disabled></el-input>
                    </el-form-item>
                </el-tab-pane>
                <el-tab-pane label="文章内容" name="4">
                    <quillEditor v-model="form.content"></quillEditor>
                </el-tab-pane>
                <el-tab-pane label="提交修改" name="5">
                    <el-button type="success" @click="onClickForEditArticle" :disabled="!$store.state.authList.includes('修改文章')">提交修改</el-button>
                </el-tab-pane>
            </el-tabs>
        </el-form>
    ...
    export default {
        ...
        methods:{
            ...
            async getCurrentArticle(){
                let {data:{article}} = await this.$http.get(`/api/article/detail?id=${this.$route.query._id}`);
                this.form = article
            }
        },
        created(){
